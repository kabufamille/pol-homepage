...
1. Coworkを開く
2. Claudeに伝える：「pol-homepegeフォルダを開いて、ホームページの修正を続けたい」
3. フォルダ選択リクエストが来たら `H:\マイドライブ\pol-homepege` を選ぶ
4. Claudeが`pol運用マニュアル.md`を読んでコンテキストを把握する

**作業はCoworkで完結させる。claude.ai Projectsは使わない。**
