...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function sendLineNotification(data) {
        // 設定済みの GAS URL
        const GAS_WEBAPP_URL = 'https://script.google.com/macros/s/AKfycbyMT-ZX9lwH-6Grdb-oJvYlXr7lHse0w8MQgHAgZ6sjHcDEblv8uH9_kj1_wAO4W2__/exec';

        console.log('Sending reservation data to GAS:', data);
        ...
        try {
            ...
            throw new Error('通知の送信に失敗しました。時間をおいて再度お試しいただくか、お電話にてご連絡ください。\n（理由: ' + fetchError.message + '）');
        }
    }
